...
| 08 | [cloud-run](./08_cloud-run/) | Cloud Run + Supabase デプロイ | Google Cloud Run, Supabase | ✅ 完成 |
| 09 | terraform | Terraform による IaC（Cloud Run / Artifact Registry） | Terraform, Google Cloud | 📋 予定 |
