-- 重複挿入を防ぐため ON CONFLICT DO NOTHING を使用
...
INSERT INTO production_results (result_date, line_code, product_code, process_code, production_qty, defect_qty, operator_name)
SELECT '2026-05-01', 'LINE-A', 'PART-001', 'PROC-01', 500, 3,  '田中'
WHERE NOT EXISTS (SELECT 1 FROM production_results LIMIT 1);
